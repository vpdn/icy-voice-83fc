...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/icy-voice-83fc
```

A live public deployment of this template is available at [https://icy-voice-83fc.templates.workers.dev](https://icy-voice-83fc.templates.workers.dev)
